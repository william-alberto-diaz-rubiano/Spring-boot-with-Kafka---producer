...
public class LibraryEventProducer {
    ...
    public SendResult<Integer,String> sendLibraryEventSynchronous(LibraryEvent libraryEvent) throws JsonProcessingException, InterruptedException, ExecutionException, TimeoutException {
        ...
        try {
            ...
            log.error("Error InterruptedException sending the message and the exception is {}", e.getMessage());
            throw e;
        } catch (ExecutionException e) {
            log.error("Error ExecutionException sending the message and the exception is {}", e.getMessage());
            throw e;
        } catch (TimeoutException e) {
            log.error("Error TimeoutException sending the message and the exception is {}", e.getMessage());
            throw e;
        }
    ...
    private void handleSucces(Integer key, String value, SendResult<Integer, String> result) {
        log.info("Messege sent succesfully for the key: {} and the value {}, partition is {}", key, value, result.getRecordMetadata().partition());
    }
}
